      ...
      <div class="row">
        <div class="col-md-6">
          <div class="img_container">
            <div class="img-box b1 text-center">
              <img src="images/bike.jpg" alt="">
            </div>
            <div class="img-box b2 text-center">
        ...
        <div class="col-md-6">
          ...
          <h2>
            ...
            <p>
              We truly value every one of our customers, so we wanted to send a quick note
              to say thank you for supproting our business.

              If you have any questions before your order arrives, please reach out without a thought.
